...
**1.** Напишете фунция, която приема 2 числа - числител и знаменател на обикновена дроб, и съкращава дробта.
</br>
**Пример:**
</br>
Вход:
...
8/15
```
**2.** Напишете програма, която по подадени 3 цели числа a, b и k прехвърля последните k цифри на a в началото на b.
</br>
**Пример:**
</br>
Вход:
...
19 57234
```
**3.** Напишете програма, която по подадено естествено число ```n``` принтира всички числа между 1 и ```n```, които имат еднакъв брой 
...
**4.** Напишете функция, която приема 2 числа и връща дали едното число е пермутация (различно подреждане) на другото
</br>
**Пример:**
</br>
Вход:
...
**5.** Напишете програма, чете естествено число 1 <= N <= 10, след това чете N на брой числа в интервала 0-127, създава едномерен масив от числата. Програмата трябва да премине през масива и ако ASCII кодът е 32–127, да отпечата съответния символ, а ако е 0–31, да пропусне елемента

Вход:
```
7
72 101 108 108 111 10 33
```
Изход:
```
Hello!
...
**6. (бонус)** *Бикове и крави* е логическа игра за отгатване на цифри. Правилата на играта са следните: </br>
