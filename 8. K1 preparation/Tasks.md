...
**6.** Напишете програма, чете естествено число 1 <= N <= 10, след това чете N на брой числа в интервала 0-127, създава едномерен масив от числата. Програмата трябва да премине през масива и ако ASCII кодът е 32–127, да отпечата съответния символ, а ако е 0–31, да пропусне елемента
...
**7. (бонус)** *Бикове и крави* е логическа игра за отгатване на цифри. Правилата на играта са следните: </br>
