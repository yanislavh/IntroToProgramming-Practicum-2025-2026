...
В резултат цикълът се изпълнява **безкрайно** и програмата никога не стига до реда std::cout << "End";, затова „End“ няма да се отпечата.
</details>
...
<details>
 <summary>Обяснение: </summary>
 Програмата ще отпечатва безкрайно „3“, защото в условието се използва **присвояване** (=) вместо **сравнение** (==).  
</details>
